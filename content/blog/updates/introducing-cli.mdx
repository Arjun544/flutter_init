...
If you'd rather point-and-click than type, the [web generator](/create) does the same thing and gives you a ZIP download. The Dart overlays match; platform runners (`android/`, `ios/`, etc.) come from the CLI via `flutter create` (or `flutter create .` after a web download).
