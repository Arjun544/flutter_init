    ...
    if (!isHydrated) {
        return (
            <main className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-background px-6">
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,var(--tw-gradient-stops))] from-primary/5 via-background/0 to-background/0" />
                <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,var(--tw-gradient-stops))] from-secondary/10 via-background/0 to-background/0" />
                <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-size-[24px_24px] mask-[radial-gradient(ellipse_50%_40%_at_50%_50%,#000_60%,transparent_100%)]" />

                <div className="relative z-10 flex w-full max-w-xs flex-col items-center text-center">
                    <div className="flex size-14 items-center justify-center rounded-2xl bg-primary/10 smooth-shadow-ring-sm smooth-ring-primary/20">
                        <Image
                            src="/logo.svg"
                            alt=""
                            width={28}
                    ...
                    <div className="mt-6 space-y-1.5">
                        <p className="text-base font-semibold tracking-tight text-foreground">
                            Restoring your wizard
                        </p>
                        <p className="text-sm leading-relaxed text-muted-foreground">
                            Loading previous selections…
                        </p>
                    </div>

                    <Spinner className="mt-8 size-5 text-primary" aria-label="Restoring session" />
                </div>
            </main>
        )
    }
        ...
        <SidebarProvider style={{ "--sidebar-width": "20rem" } as React.CSSProperties}>
            ...
            <SidebarInset className="min-w-0 relative flex flex-col min-h-dvh">
                ...
                <header className="sticky top-0 z-30 flex h-20 shrink-0 items-center justify-between border-b border-border/40 bg-background/80 backdrop-blur-xl px-4 md:px-6">
                    ...
                    <div className="flex items-center gap-3">
                        <Button
                            ...
                            className="hidden rounded-xl lg:inline-flex h-10 px-4 border-border/40 bg-background/50 smooth-shadow-xs cursor-pointer"
                        >
                            <Link
                        ...
                        <Button
                            ...
                            className="h-10 px-4 border-border/40 bg-background/50 rounded-xl smooth-shadow-sm cursor-pointer"
                        >
                        ...
                        <Button
                            ...
                            className={cn(
                                "h-10 px-5 rounded-xl border-0 bg-clip-border smooth-shadow-sm cursor-pointer min-w-25",
                                stepIndex === stepOrder.length - 1 && "bg-primary hover:bg-primary/90 smooth-shadow-lg shadow-primary/25 font-semibold text-primary-foreground"
                            )}
                        >
                            {isGenerating ? (
                                "Generating…"
                ...
                <div className="flex-1 overflow-auto selection:bg-primary/20">
                    <main className="w-full p-4 sm:p-6 lg:p-8 xl:px-10 pb-28">
                        <div className="w-full max-w-350">
                            <h1 className="sr-only">
                                Flutter Project Configuration Wizard - {steps[step].title}
                            </h1>
                ...
                <Button
                    ...
                    className={cn(
                        ...
                        "bg-primary text-primary-foreground smooth-shadow-lg",
        ...
        <Sidebar variant="sidebar" className="border-r border-border/40 bg-background/50 backdrop-blur-xl">
            <SidebarHeader className="border-b border-border/40 p-4">
                <div className="flex items-center gap-3">
                    <Link
                        href="/"
                        className="flex size-10 shrink-0 items-center justify-center rounded-xl bg-primary/10 smooth-shadow-ring-sm smooth-ring-primary/20 transition-transform duration-200 hover:scale-105"
                    >
                        <Image
                            src="/logo.svg"
            ...
            <SidebarContent className="no-scrollbar px-3 py-5">
                <SidebarGroup className="p-0">
                    ...
                    <Highlight
                        ...
                        className="pointer-events-none rounded-2xl bg-primary/10 smooth-shadow-ring-sm smooth-ring-primary/15 shadow-primary/5 dark:bg-primary/15"
                                ...
                                <HighlightItem key={id} value={id} asChild>
                                    <SidebarMenuItem className="relative z-10">
                                        ...
                                        >
                                            <div
                                                className={cn(
                                                    "flex size-9 shrink-0 items-center justify-center rounded-xl text-[10px] font-semibold transition-all duration-300",
                                                    isActive
                                                        ? "bg-primary text-primary-foreground smooth-shadow-ring-md shadow-primary/20"
                                                        : isCompleted
                                                            ? "border border-primary/20 bg-primary/10 text-primary"
                                                            : "border border-border/80 bg-background/40 text-muted-foreground",
                                                )}
                                            >
                                                {isCompleted ? (
            ...
            <SidebarFooter className="border-t border-border/40 p-3">
                <div className="rounded-2xl bg-card/40 p-3.5 smooth-shadow-ring-sm backdrop-blur-sm">
