...
function HexagonBackground({
  ...
  hexagonSize = 75,
  hexagonMargin = 3,
  hexagonStroke: hexagonStrokeProp,
  ...props
  ...
  // Grid gap uses hexagonMargin; stroke width is independent when hexagonStroke is set.
  const hexagonStroke =
    hexagonStrokeProp ?? (hexagonMargin > 0 ? hexagonMargin : 1);
  ...
  return (
    <div
      ...
      {...props}
    >
      <style>{`:root { --hexagon-stroke: ${hexagonStroke}px; }`}</style>
              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "after:content-[''] after:absolute after:inset-(--hexagon-stroke) dark:after:bg-neutral-950 after:bg-white",
